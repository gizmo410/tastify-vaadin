 ...
 * @since 11/05/14
 */
public class ReviewRegistered implements Serializable {
    ...
    protected ReviewRegistered() {
    }

    public ReviewRegistered(final Builder builder) {
        this.reviewId = reviewId;
        this.name = builder.name;
        this.email = builder.email;
        this.hasRudeWords = builder.hasRudeWords;
        this.markedAsAbuse = builder.markedAsAbuse;
    ...
    public boolean equals(Object obj) {
        ...
        final ReviewRegistered other = (ReviewRegistered) obj;
        return Objects.equal(this.reviewId, reviewId)
    ...
    public String toString() {
        return Objects.toStringHelper(this)
                .add("review_id", reviewId.getIdentifier())
                .add("name", name)
                .add("email", email)
    ...
    public static class Builder implements IsBuilder<ReviewRegistered> {
        ...
        public Builder markedAsAbuse(final boolean marked_as_abuse) {
            this.markedAsAbuse = marked_as_abuse;
            return this;
        }
        ...
        @Override
        public ReviewRegistered build() {
            return new ReviewRegistered(this);
        }
    }
